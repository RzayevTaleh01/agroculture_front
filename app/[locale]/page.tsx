                  ...
                  performance
                    ...
                    <div className="flex-1 relative">
                        <div className=" h-full flex flex-col  dark:bg-default-100 bg-white">
                            <div
                                className="max-w-[524px] md:px-[42px] md:py-[44px] p-7  mx-auto w-full text-2xl text-default-900  mb-3 h-full flex flex-col justify-center">
                                ...
                                <div className="text-center">
                                    <h4 className="font-medium">Daxil ol</h4>
                                </div>
                                <LoginForm/>
                            </div>
